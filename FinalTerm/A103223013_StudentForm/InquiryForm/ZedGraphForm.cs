...
namespace InquiryForm
{
    public partial class ZedGraphForm : Form
    {
        ...
        public ZedGraphForm(string showString,string topTitle)
        {
            InitializeComponent();
        ...
        // 製作 PieChart
        public void CreatePieChart(string topTilte)
        {
            zedGraphPane.CurveList.Clear();
            zedGraphPane.Title.Text = topTilte;

            Color[] colors = { Color.Green, Color.Yellow, Color.Red, Color.Blue, Color.Purple };
            int colorIndex = 0;
